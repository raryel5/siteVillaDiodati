...
<div class="text-centralizado">
    ...
    <form action="{{ route('formLancamento-store') }}" method="POST">
    ...
    <input type="string" class="form-group" name="number" placeholder="Número ou (S/N)" required><b> <?php echo $obrigatorio ?> </b>
    ...
    <label for="state" class="">Estato:</label><br>
