...
<section class="section-corpo">
    ...
    <div style="font-size: clamp(1rem, 0.8vw + 1rem, 1.5rem); line-height: clamp(1rem, 1.3vw + 1rem, 2rem); text-align: justify">
        ...
        <p>O Villa Diodati existe porque alguns escritores decidiram que a solidão do ofício literário não precisava ser condição permanente de quem cria fora dos grandes circuitos. E o que construímos juntos, livro por livro, decisão por decisão, é a melhor resposta que podemos dar a essa convicção.</p>
    </div>
